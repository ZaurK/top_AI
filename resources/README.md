...
2.	Мазуров, Вл. Д. Математические методы распознавания образов: уч. пособ. 2-е изд., доп. и перераб. – Екатеринбург: Изд-во Урал. ун-та, 2010. – 101 с.
...
5.	Портал «Машинное обучение» [электронный ресурс]. – URL: http://www.machinelearning.ru/wiki/index.php?title=%D0%9C%D0%BE.

---

* Дата обращения к приведенным URL - 29.07.2026.
